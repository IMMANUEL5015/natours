...
exports.deleteUser = exports.logout = exports.login = exports.forgotPassword = exports.resetPassword = exports.signup = exports.updateSettings = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'Password' ? '/api/v1/users/updatePassword' : '/api/v1/users/me';
            _context.next = 4;
            return axios({
              method: 'PATCH',
              url: url,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Account created successfully! Please check your email inbox.');
              window.setTimeout(function () {
                location.assign('/');
              }, 2500);
            }
...
var resetPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(password, passwordConfirm, resetToken) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Reset password successful!');
              window.setTimeout(function () {
                location.assign('/');
              }, 6000);
            }
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your password reset link has been sent to your email address.');
            }
...
var login = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(email, password) {
    var res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'An error occured. Try Again!');
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"tour.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.displayMap = exports.deleteTour = exports.bookTour = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_tFzRlFeRIFMIr1wwOA842gqk00hzu5wJ2m');
            _context.prev = 1;
            _context.next = 4;
...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.635621, 34.153231],
    // interactive: false,
    // zoom: 10

  });
  var bounds = new mapboxgl.LngLatBounds(); // Create the marker
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " ").concat(loc.description, "<p>")).addTo(map); //Extend the Bounds object for the current location
...
},{"../../node_modules/axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"review.js":[function(require,module,exports) {
"use strict";
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(review, rating, tour, slug) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var updateReview = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(review, rating, tour, reviewId, slug) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return axios({
              method: 'PATCH',
              url: "/api/v1/tours/".concat(tour, "/reviews/").concat(reviewId),
              data: {
                review: review,
                rating: rating
              }
  ...
  return function updateReview(_x5, _x6, _x7, _x8, _x9) {
    return _ref2.apply(this, arguments);
  };
}(); //3. Delete Review
...
var deleteReview = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(tour, reviewId, slug) {
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/tours/".concat(tourId, "/add-to-favorites")
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Added to favorites');
              window.setTimeout(function () {
                location.reload(true);
              }, 6000);
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Failed to add tour to favorites. Try Again.');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/tours/".concat(tourId, "/remove-from-favorites")
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Successfully removed from favorites.');
              window.setTimeout(function () {
                location.reload(true);
              }, 6000);
            }
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('error', 'Failed to remove tour from favorites. Try again.');
...
},{"./alerts":"alerts.js","../../node_modules/axios":"../../node_modules/axios/index.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
if (bookTourBtn) {
  bookTourBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; //using object destructuring

    var tourId = e.target.dataset.tourId;
    (0, _tour.bookTour)(tourId);
  });
} //Delete a tour


var deleteTourBtn = document.getElementById('deleteTour');

if (deleteTourBtn) {
  deleteTourBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              deleteTourBtn.textContent = 'Processing...'; //using object destructuring

              tourId = e.target.dataset.tourId;
              _context.next = 4;
              return (0, _tour.deleteTour)(tourId);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return (0, _user.login)(email, password);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 8;
              return (0, _user.signup)(email, name, password, passwordConfirm);
...
if (updateDataForm) {
  updateDataForm.addEventListener('submit', function (e) {
    ...
    (0, _user.updateSettings)(form, 'Data');
  });
...
var toggler = document.getElementById('nav__items--toggle');
...
if (logoutButton) {
  logoutButton.addEventListener('click', _user.logout);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              email = document.getElementById('email').value;
              _context5.next = 5;
              return (0, _user.forgotPassword)(email);
      ...
      return regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              e.preventDefault();
              resetToken = document.querySelector('.btn--reset-password').dataset.resetToken;
              document.querySelector('.btn--reset-password').textContent = 'Please wait...';
              password = document.getElementById('password').value;
              passwordConfirm = document.getElementById('passwordConfirm').value;
              _context6.next = 7;
              return (0, _user.resetPassword)(password, passwordConfirm, resetToken);
...
if (deleteUserBtn) {
  deleteUserBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(e) {
      ...
      return regeneratorRuntime.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              deleteUserBtn.textContent = 'Processing...'; //using object destructuring

              userId = e.target.dataset.userId;
              _context7.next = 4;
              return (0, _user.deleteUser)(userId);
...
var createReviewForm = document.querySelector('.form--review');

if (createReviewForm) {
  createReviewForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(e) {
      var review, rating, submitLink, submitLinkArr, tour, slug;
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              submitLink = document.getElementById('create-review-button').dataset.submitLink;
              submitLinkArr = submitLink.split(',');
              tour = submitLinkArr[0];
              slug = submitLinkArr[1];
              _context8.next = 10;
              return (0, _review.createReview)(review, rating, tour, slug);
...
var updateReviewForm = document.querySelector('.form--review-update');

if (updateReviewForm) {
  updateReviewForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(e) {
      var review, rating, updateLink, updateLinkArr, tour, reviewId, slug;
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              review = document.getElementById('review').value;
              rating = document.getElementById('rating').value;
              updateLink = document.getElementById('update-review-button').dataset.updateLink;
              updateLinkArr = updateLink.split(',');
              tour = updateLinkArr[0];
              reviewId = updateLinkArr[1];
              slug = updateLinkArr[2];
              _context9.next = 11;
              return (0, _review.updateReview)(review, rating, tour, reviewId, slug);
...
var deleteReviewBtn = document.querySelector('#delete-review');
...
if (deleteReviewBtn) {
  deleteReviewBtn.addEventListener('click', /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(e) {
      var deleteLink, deleteLinkArr, tour, reviewId, slug;
      return regeneratorRuntime.wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              deleteReviewBtn.textContent = 'Deleting...';
              deleteLink = deleteReviewBtn.dataset.deleteLink;
              deleteLinkArr = deleteLink.split(',');
              tour = deleteLinkArr[0];
              reviewId = deleteLinkArr[1];
              slug = deleteLinkArr[2];
              _context10.next = 8;
              return (0, _review.deleteReview)(tour, reviewId, slug);
...
var likeTourBtn = document.getElementById('likeTour');

if (likeTourBtn) {
  likeTourBtn.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              tourId = likeTourBtn.dataset.tourId;
              _context11.next = 4;
              return (0, _favorites.addToFavorites)(tourId);
...
var dislikeTourBtn = document.getElementById('dislikeTour');

if (dislikeTourBtn) {
  dislikeTourBtn.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
              ...
              tourId = dislikeTourBtn.dataset.tourId;
              _context12.next = 4;
              return (0, _favorites.removeFromFavorites)(tourId);
