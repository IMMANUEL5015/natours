      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios({
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/users/resetPassword/".concat(resetToken),
              data: {
                password: password,
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'Password' ? 'http://127.0.0.1:8000/api/v1/users/updatePassword' : 'http://127.0.0.1:8000/api/v1/users/me';
            _context.next = 4;
            return axios({
              method: 'PATCH',
              url: url,
